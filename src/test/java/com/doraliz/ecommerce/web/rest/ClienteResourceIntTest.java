...
import com.doraliz.ecommerce.repository.ClienteRepository;
...
public class ClienteResourceIntTest {
    ...
    private static final ClienteEstado DEFAULT_ESTADO = ClienteEstado.ACTIVO;
    private static final ClienteEstado UPDATED_ESTADO = ClienteEstado.INACTIVO;
