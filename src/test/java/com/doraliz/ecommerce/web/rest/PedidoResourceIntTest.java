...
import static com.doraliz.ecommerce.web.rest.TestUtil.sameInstant;
...
public class PedidoResourceIntTest {
    ...
    private static final EstadoPedido DEFAULT_ESTADO = EstadoPedido.GENERADO;
    private static final EstadoPedido UPDATED_ESTADO = EstadoPedido.ACEPTADO;

    private static final BigDecimal DEFAULT_MONTO_VENTA = new BigDecimal(1);
    private static final BigDecimal UPDATED_MONTO_VENTA = new BigDecimal(2);

    private static final FormaPago DEFAULT_FORMA_PAGO = FormaPago.CONTADO;
    private static final FormaPago UPDATED_FORMA_PAGO = FormaPago.CUOTAS;
    ...
    public static Pedido createEntity(EntityManager em) {
        Pedido pedido = new Pedido()
            ...
            .montoVenta(DEFAULT_MONTO_VENTA)
    ...
    public void createPedido() throws Exception {
        ...
        assertThat(testPedido.getMontoVenta()).isEqualTo(DEFAULT_MONTO_VENTA);
        assertThat(testPedido.getFormaPago()).isEqualTo(DEFAULT_FORMA_PAGO);
    }
    ...
    @Test
    @Transactional
    public void checkMontoVentaIsRequired() throws Exception {
        int databaseSizeBeforeTest = pedidoRepository.findAll().size();
        // set the field null
        pedido.setMontoVenta(null);
    ...
    public void getAllPedidos() throws Exception {
        ...
        restPedidoMockMvc.perform(get("/api/pedidos?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].montoVenta").value(hasItem(DEFAULT_MONTO_VENTA.intValue())))
    ...
    public void getPedido() throws Exception {
        ...
        restPedidoMockMvc.perform(get("/api/pedidos/{id}", pedido.getId()))
            ...
            .andExpect(jsonPath("$.montoVenta").value(DEFAULT_MONTO_VENTA.intValue()))
    ...
    public void updatePedido() throws Exception {
        ...
        updatedPedido
            ...
            .montoVenta(UPDATED_MONTO_VENTA)
        ...
        assertThat(testPedido.getMontoVenta()).isEqualTo(UPDATED_MONTO_VENTA);
        assertThat(testPedido.getFormaPago()).isEqualTo(UPDATED_FORMA_PAGO);
    }
